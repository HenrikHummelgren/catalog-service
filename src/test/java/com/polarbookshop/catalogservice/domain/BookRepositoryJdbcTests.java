...
class BookRepositoryJdbcTests {
    ...
    @Test
    void findAllBooks() {
        var book1 = Book.of("1234561235", "Title", "Author", 12.90, "Arktis Förlag");
        var book2 = Book.of("1234561236", "Another Title", "Author", 12.90, "Arktis Förlag");
    ...
    void findBookByIsbnWhenExisting() {
        ...
        var book = Book.of(bookIsbn, "Title", "Author", 12.90, "Arktis Förlag");
    ...
    void existsByIsbnWhenExisting() {
        ...
        var bookToCreate = Book.of(bookIsbn, "Title", "Author", 12.90, "Arktis Förlag");
